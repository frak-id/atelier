...
function rowToSandbox(row: typeof sandboxes.$inferSelect): Sandbox {
  return {
    ...
    status: row.status,
    runtime: row.runtime,
    agentWorkspaceContext: row.agentWorkspaceContext ?? undefined,
  ...
  create(sandbox: Sandbox): Sandbox {
    getDatabase()
      ...
      .values({
        ...
        agentWorkspaceContext: sandbox.agentWorkspaceContext ?? null,
  ...
  update(id: string, updates: Partial<Sandbox>): Sandbox {
    ...
    getDatabase()
      ...
      .set({
        ...
        agentWorkspaceContext: updated.agentWorkspaceContext ?? null,
