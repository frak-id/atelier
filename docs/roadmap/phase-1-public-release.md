...
```typescript
// infra/cli/src/commands/init.ts
...
```typescript
// infra/cli/src/lib/dns-providers/cloudflare.ts
...
```typescript
// infra/cli/src/lib/prerequisites.ts
  ...
  build:
    ...
    steps:
      ...
      - uses: actions/upload-artifact@v4
        with:
          name: cli-linux-x64
          path: infra/cli/dist/frak-sandbox-linux-x64
```
